            ...
            <div class="row">
                <div class="col-md-4 pb-5">
                    <div class="form-group">
                        ...
                        <select ng-model="measure" ng-change="submitMeasure(measure)" class="form-control rounded-0 text-center" ng-init="measure" ng-options="x for x in measures"></select>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="form-group">
                        <h1 class="text-center">Unit</h1>
                        <select ng-model="unit" ng-change="submitUnit(unit)" class="form-control rounded-0 text-center" ng-init="unit" ng-options="x for x in unitsOfMeasure"></select>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="form-group">
                        <h1 class="text-center">Quantity</h1>
                        <input type="number" min="0.000000000000001" ng-model="quantity" ng-change="submitQuantity()" class="form-control rounded-0 text-center">
                    </div>
                </div>
...
<footer class="py-5 bg-dark text-muted">
    <div class="container">
        ...
        <p>© Copyright 2018 coffecode.org - All rights reserved.<br>Contact: info@coffecode.org<br>02-619 Warsaw<br><a href="https://www.coffecode.org/">Visit the homepage</a>
        </p>
    </div>
</footer>
</body>
